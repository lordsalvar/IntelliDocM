...
// Check if proposal_id and signed_by are provided in the URL
if (isset($_GET['proposal_id']) && isset($_GET['signed_by'])) {
    $proposal_id = (int)$_GET['proposal_id'];
    $signed_by = htmlspecialchars($_GET['signed_by']);
    ...
    if ($result->num_rows > 0) {
        ...
        $verificationResult = [
            ...
            'Signed By' => $signed_by,
            'Applicant Name' => $proposal['applicant_name'],
            'Submission Date' => $proposal['applicant_date_filed'],
        ];
    } else {
...
<body>
    <div class="container">
        <div class="text-center">
            <h1 class="my-4">QR Code Verification</h1>
        </div>
