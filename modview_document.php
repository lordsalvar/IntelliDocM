...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generate_qr'])) {
    ...
    if ($updateStmt->execute()) {
        echo "<script>alert('Moderator signature added and QR code generated successfully.'); window.location.href='modview_document.php?id=$id';</script>";
    } else {
...
<body>
    <div class="dashboard">
        ...
        <div class="container my-5">
            <a class="btn btn-secondary mb-3 back-button" href="/main/intellidocm/moderator_dashboard.php">← Back</a>
            <!-- Overlay Box -->
            ...
            <?php if ($proposal): ?>
                ...
                <div class="text-center">
                    ...
                    <input placeholder="Dean" class="form-control mb-2 text-center" value="<?= htmlspecialchars($proposal['dean_name']) ?>" readonly />
