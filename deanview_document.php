...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generate_qr'])) {
    ...
    if ($updateStmt->execute()) {
        echo "<script>alert('Dean signature added and QR code generated successfully.'); window.location.href='deanview_document.php?id=$id';</script>";
    } else {
        ...
        <div class="container my-5">
            ...
            <?php if ($proposal): ?>
                ...
                <div class="text-center">
                    ...
                    <input placeholder="Dean" type="text" class="form-control mb-2 text-center" value="<?= htmlspecialchars($proposal['dean_name']) ?>" readonly />
